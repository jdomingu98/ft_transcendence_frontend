...
export default Component(
    ...
    class ModalRegister extends WebComponent {
        ...
        restoreModal(modal)
        {
            ...
            const formFields = modal.querySelectorAll('form-field');
            formFields.forEach(field => {
                const input = field._getDOM().querySelector('input');
                if (input) {
                    input.value = '';
                }
            });
        ...
        sendData(){
            ...
            if(!this.handleEmptyForms(data) || !this.handleCheckboxChange())
            {
                ...
                console.log("Unos de los form no esta completos");
                return ;
            }
            ...
            ).then(response => console.log("Repuesta correcto",response))
            .catch(error => {
                this.handleErrorForm(error);
            })
            // Spinner
