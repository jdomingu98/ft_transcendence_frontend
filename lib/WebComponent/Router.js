...
class Router {
     ...
     * @readonly
     */
    static _currentPath = window.location.pathname;
    ...
    static match(regexPath) {
        ...
        const pathnameParts = Router._removeEndingSlash(Router._currentPath).split('/');
        ...
        Router._currentPath = '/' + pathnameParts.slice(regexParts.length).join('/');
