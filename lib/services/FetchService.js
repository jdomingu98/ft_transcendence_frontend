...
class FetchServiceAuth {
    ...
    static async get(url, options = {}) {
        ...
        return fetch(url, {
            ...
            .then(FetchServiceAuth.genericCallback(() => FetchService.get(url, options)));
    }
    ...
    static async post(url, data, options = {}) {
        ...
        return fetch(url, {
            ...
            .then(FetchServiceAuth.genericCallback(() => FetchService.post(url, data, options)));
    }
    ...
    static async put(url, data, options = {}) {
        ...
        return fetch(url, {
            ...
            .then(FetchServiceAuth.genericCallback(() => FetchService.put(url, data, options)));
    }
    ...
    static async patch(url, data, options = {}) {
        ...
        return fetch(url, {
            ...
            .then(FetchServiceAuth.genericCallback(() => FetchService.patch(url, data, options)));
    }
    ...
    static async delete(url, options = {}) {
        ...
        return fetch(url, {
            ...
            .then(FetchServiceAuth.genericCallback(() => FetchService.delete(url, options)));
    }
